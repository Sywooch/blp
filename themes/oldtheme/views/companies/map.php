...
<div id ="map-wrapper">
    ...
    <div class ='company-wrap'>
        <div id ='company-baloon' >
            <div><img src="" class = 'company-img'></div>
            <a href ='' class ='review-link' target="_blank" >Оставить отзыв</a>
            <div>
                <span class = 'non-active'>Филиал закрыт</span>
            </div>
            <div>
                <a class ='company-name' href='' target="_blank"></a>
            </div>
            <div>
                <a class ='company-branch' href ='' target="_blank"></a>
            </div>
            <div>
                <span class ='des-label company-functions'></span>
            </div>
            <div>
            ...
            <div>
                ...
                <span class ='company-works-hours'></span>
            </div>
            <div>
                <span class ='des-label'>Телефон:</span> 
                <span class ='company-phones'></span>
            </div>
            <div>
