...
<div style="position: absolute; width: 100%; background-color: red; padding: 10px;">
    <div style="width: 650px; margin: 0 auto;">
        <span style="font-family: arial;font-size: 36px; color: white;"><a style="text-decoration:none; color:white;" href="http://www.711.ru"><i>711</i></a></span><span style="font-family: arial;font-size: 22px; color: white; margin-left: 184px;">К Вам поступила новая заявка </span>
    </div>
</div>

        <p style="font-size: 17px; font-family: arial;">Уведомляем Вас о появлении новой заявки. </p>
        <p style="font-size: 17px; font-family: arial;">Заявка должна быть взята в работу, либо она будет перенаправленна другому агенту.</p>
