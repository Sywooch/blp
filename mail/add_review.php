                ...
                <tr>
                    <td colspan="2"style="padding: 15px; padding-bottom: 0;">
                        <span style="color: #424955; font: 16px Arial, sans-serif; line-height: 24px; -webkit-text-size-adjust:none; display: block;">
                            Ваш отзыв о работе компании <?= $company_name ?> одобрен и успешно размещен.
                        </span>
                    </td>
                </tr>
                <tr>
                    <td colspan="2"style="padding: 15px;">
                        <span style="color: #424955; font: 16px Arial, sans-serif; line-height: 24px; -webkit-text-size-adjust:none; display: block;">
                            Спасибо, что нашли время поделиться с нами своим опытом.
                        </span>
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#4d81ef" align="center" style="padding: 15px">
                        <a href="<?= $url ?>" target="_blank" style="text-decoration: none; color: #ffffff !important; font: 16px Arial, sans-serif; line-height: 24px; -webkit-text-size-adjust:none; display: block;">
                            <span style="display: block; color: white;">Страница с отзывом доступна по ссылке</span>
                        </a>
                    </td>
                </tr>
                <tr>
