...
<div style="width:940px;">
	...
	<div style="background:white;">
            <div style="background:#f3f3f3;padding:20px 10px;border-bottom:1px solid #bebebe;">
                <div></div>
            </div>
...
<div style="float:right;width:290px;">
    ...
    <div style="background:white;font-size:14px;">
        ...
        <div style="border-bottom:1px solid white;padding:20px 10px;background:#f3f3f3;"><a href="/indexexpert" class="underline">Раздел эксперты</a></div>
        ...
        <div style="border-bottom:1px solid #f3f3f3;padding:20px 10px;"><a href="/cabinet/banners" class="underline">Баннеры</a></div>
